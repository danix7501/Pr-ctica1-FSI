...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Nodos expandidos: ", contarNodos
            return node
...
def branch_and_bound_search(problem):
    return tree_search(problem, Branch_and_Bound())

def branch_and_bound_heuristic_search(problem):
    return tree_search(problem, Branch_and_Bound_Heuristic(problem))
